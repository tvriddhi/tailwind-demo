...
import './App.css';
import { heroImg, logo, Logo1, Logo2, Logo3, Logo4, Logo5, manageIcon } from './assets/images';
  ...
  return (
    <>
      ...
      <section className='py-24 bg-slate-50'>
        <div className='xl:container lg:container px-6 sm:px-14 lg:px-6'>
          <div className='grid grid-cols-12 gap-4 items-center'>
            <div className='lg:col-span-7 col-span-12'>
              <h1 className='text-6xl'>Lessons and insights <span className='text-green-600'>from 8 years</span></h1>
              ...
              <div className='lg:col-span-4 lg:col-start-9 col-start-3 col-span-8'>
                <img
                  className='w-full'
                  alt="hero img"
                  src={heroImg}
      ...
      <section className='our-client py-10'>
          <div className='xl:container lg:container px-6 sm:px-14 lg:px-6'>
            ...
            <div className='flex content-between gap-4 flex-wrap'>
        ...
        <div className='xl:container lg:container px-6 sm:px-14 lg:px-6'>
          ...
          <div className='grid grid-cols-12 gap-4'>
            <div className='col-span-3 col-start-1'>
              <img alt='manageIcon' src={manageIcon}/>
            </div>
            <div className='col-span-3 col-start-1'>
              <img alt='manageIcon' src={manageIcon}/>
            </div>
